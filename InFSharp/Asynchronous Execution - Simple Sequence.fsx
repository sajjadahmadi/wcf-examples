...
let asyncResult1 = client.BeginAdd(2, 3, null, null)
let asyncResult2 = client.BeginAdd(4, 5, null, null)

// some other work

printfn "2 + 3 = %d" (client.EndAdd(asyncResult1))
printfn "4 + 5 = %d" (client.EndAdd(asyncResult2))
