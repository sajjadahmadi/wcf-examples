...
host.AddServiceEndpoint(typeof<IServiceContract>, new WSHttpBinding(), "explicitendpoint")
// Default endpoints can be added explicitly
host.AddDefaultEndpoints() |> ignore
host.Open()
